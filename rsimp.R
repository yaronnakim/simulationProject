...
QAprocess <- 
  ...
  branch(option=function() ifelse(function() get_attribute(mamara, key="defectsCounter",  global = TRUE)>22 ,1, 0), continue= c(TRUE), QAtest)%>%#if the condition is true- return 1 else 
